    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8 mt-5">
                ...
                <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg px-4 py-4">
                    ...
                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        <b>E-Smart Shopper - Admin Page</b><br><br>
                        <button wire:click="showModal()" class="bg-green-500 hover:bg-green-700 text-white font-bold py-1 px-4 rounded mb-2">
                                          Create Customer Data
                        </button>
                    </div>
                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        <input wire:model="search" type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-blue-900" placeholder="Search Customer Name...">           
                    </div>                     
                    </div>
                        ...
                        <tbody>
                            ...
                            <tr>          
                                ...
                                <td class="px-12 py-3">
                                    ...
                                    <button wire:click="delete({{ $post->id }})" class="bg-red-500 hover:bg-green-700 text-white font-bold py-1 px-4 rounded">
                                    Delete
                                    </button>
                                </td>
                            </tr>
